...
| 🔌 **Bring any model** | Anthropic, OpenAI, Gemini, OpenRouter, OrcaRouter, Token Market, Opper, Groq, Cerebras, xAI, DeepSeek, Mistral, local Ollama, or any OpenAI-compatible endpoint. Switch mid-conversation. |
...
OpenRouter, OrcaRouter, Token Market, Opper, Ollama, and more), **(2) connect it** (paste an API key, **sign in with a
...
Opper, Groq, Cerebras, xAI, DeepSeek, Mistral, **Ollama** (local), and **Custom**
