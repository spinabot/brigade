...
import { MEMORY_SEGMENTS } from "../store/records.js";
import type { MemoryRecord, MemoryRecordOrigin, MemorySegment, NewFact } from "../store/records.js";
import { confineUntrustedSegment } from "../governance/write-gate.js";
