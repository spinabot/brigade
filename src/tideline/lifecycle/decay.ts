...
import { FactStore, type FactStoreOptions, type MemoryRecord } from "../store/records.js";
 ...
 */
export function runDecayGc(workspaceDir: string, now: number = Date.now(), storeOptions: FactStoreOptions = {}): DecayResult {
