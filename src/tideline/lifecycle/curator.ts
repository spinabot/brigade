// src/tideline/lifecycle/curator.ts
//
...
import type { FactStore, RecordOriginFilter } from "../store/records.js";
import { writeVault } from "../exports/vault.js";
...
export function runCurator(
	...
	// (with external persistence the backend is authoritative; an on-disk vault would be an
	...
	if (opts.vaultDir && changed && store.isFilesystemBacked) {
