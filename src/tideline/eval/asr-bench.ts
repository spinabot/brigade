// src/tideline/eval/asr-bench.ts
//
...
import type { FactStoreOptions, NewFact } from "../store/records.js";
import { FactStore } from "../store/records.js";
import { WriteGateError } from "../governance/write-gate.js";
...
export function runDefaultAsrBench(workspaceDir: string, storeOptions: FactStoreOptions = {}): AsrResult {
	const store = new FactStore(workspaceDir, storeOptions);
