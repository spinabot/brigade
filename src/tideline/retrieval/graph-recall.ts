// src/tideline/retrieval/graph-recall.ts
//
...
import { buildGraph, neighbors, spread } from "../graph/graph.js";
import { getDefaultEmbedder, type Embedder } from "../embeddings/embedder.js";
import { prepareRecallQuery, recallHybrid, type HybridScored } from "./hybrid.js";
