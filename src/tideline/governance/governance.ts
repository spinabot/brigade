// src/tideline/governance/governance.ts
//
...
import { backlinksTo, linksFrom, type MemoryLink, type MemoryLinkKind } from "../graph/links.js";
import { FactStore, recordMatchesOriginFilter, type MemoryRecord, type RecordOriginFilter } from "../store/records.js";
